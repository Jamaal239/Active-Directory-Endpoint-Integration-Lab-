...
* **Network Isolation:** Configured an isolated internal network switch (`intnet`) to enforce strict local routing boundaries, demonstrating a strong understanding of sandbox security.
...
* **Step 1: Base Virtual Appliance Network Configuration**
  ![Network Settings](screenshots/screenshot_1.png)
...
* **Step 2: Active Directory Domain Services (AD DS) Initialization**
  ![Server Manager Dashboard](screenshots/screenshot_2.png)
...
* **Step 3: Virtual Disk and Hardware Allocation**
  ![VDI Allocation](screenshots/screenshot_3.png)
...
* **Step 4: Hypervisor Interface Hardening**
  ![Workstation Adapter Settings](screenshots/screenshot_4.png)
...
* **Step 5: Storage Volumetrics & Target Drive Partitioning**
  ![Windows 11 Target Partition](screenshots/screenshot_5.png)
...
* **Step 6: Local Security Account Manager (SAM) Initial Provisioning**
  ![Out-of-Box Experience Profile](screenshots/screenshot_6.png)
...
* **Step 7: Hypervisor Guest Addition Subsystem Deployment**
  ![VirtualBox Guest Additions Setup](screenshots/screenshot_7.png)
...
* **Step 8: Hostname Standardization**
  ![System Renaming](screenshots/screenshot_8.png)
...
* **Step 9: Static IPv4 Schema & DNS Pointer Mapping**
  ![TCP/IPv4 Network Properties](screenshots/screenshot_9.png)
...
* **Step 10: Connectivity Validation & Inter-VM Routing Fix**
  ![Successful ICMP Validation](screenshots/screenshot_10.png)
...
* **Step 11: Domain Directory Authentication Challenge**
  ![Domain Join Credential Box](screenshots/screenshot_11.png)
...
* **Step 12: Successful Domain Admission**
  ![Welcome to Domain Prompt](screenshots/screenshot_12.png)
...
* **Step 13: Centralized Identity Session Initiation**
  ![Domain Profile Login View](screenshots/image_148420.jpg)
...
* **Step 14: Cryptographic Token & Environment Verification**
  ![Whoami Context Validation](screenshots/screenshot_14.png)
